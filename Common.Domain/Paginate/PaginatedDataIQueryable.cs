...
public class PaginatedDataIQueryable<T> : List<T> where T : class
{
    ...
    public PaginatedDataIQueryable(IQueryable<T> source, FilterBase filter, int totalCount)
    {
        this.Paging(source, filter, totalCount);
    }
    public PaginatedDataIQueryable(IQueryable<T> source, FilterBase filter)
    {
    ...
    private void Paging(IQueryable<T> source, FilterBase filter, int totalCount)
    {
